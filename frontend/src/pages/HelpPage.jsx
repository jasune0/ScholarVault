...
const STEPS = [
  ...
  { num: '3', title: 'View Paper Details', body: 'Click any result card to open the full paper detail page. You\'ll see the abstract, full author list, citation count, DOI and journal info.' },
